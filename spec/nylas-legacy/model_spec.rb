...
describe NylasLegacy::Model do
  ...
  describe "#save" do
    it "raises a NotImplementedError exception if the model is flagged as not updatable" do
      ...
      expect { instance.save }.to raise_error(NylasLegacy::ModelNotUpdatableError)
    end
    ...
    it "raises a ModelNotCreatable exception if the model is new and is flagged as not creatable" do
      ...
      expect { instance.save }.to raise_error(NylasLegacy::ModelNotCreatableError)
    end
  end
  ...
  describe "#update" do
    it "raises a NotImplementedError exception if the model is flagged as read only" do
      ...
      expect { instance.update(name: "other") }.to raise_error(NylasLegacy::ModelNotUpdatableError)
    end
    ...
    it "raises a MissingFieldError if attempting to set a field that does not exist" do
      ...
      end.to raise_error(NylasLegacy::ModelMissingFieldError, expected_message)
    end
  end
  ...
  describe "#reload" do
    ...
    it "assigns the attributes that do exist" do
      ...
      expect { instance.attributes[:fake_attribute] }.to raise_error NylasLegacy::Registry::MissingKeyError
    end
  end
